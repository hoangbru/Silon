                ...
                <div class="container-fluid">
                    <div class="form_login">
                        <form action="index.php?act=dangky" method="post">
                            <h3 style="margin: 0;">Đăng kí</h3>
                            <div class="form_group">
                                <label for="fullname"></label>
                                <input type="text" name="fullName" id="username" placeholder=" Họ và tên">
                            </div>
                            <div class="form_group">
                            ...
                            <input type="submit" id="signin_submit" name="dangky" value="Đăng kí">
                        </form>
                    </div>
                    <div class="ban-img">
